...
<div class="row">
    ...
    <button class='btn btn-xs btn-success' type="button" name="button">
        <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span> <?= $model->votosPositivos()  ?>
     </button>
    <button class='btn btn-xs btn-danger' type="button" name="button">
        <span class="glyphicon glyphicon-thumbs-down" aria-hidden="true"></span> <?= $model->votosNegativos()  ?>
    </button>
</div>
</div>
